...
Ext.define('DDDraggable', {
  ...
  _mouseDown: function(e) {
    ...
    if (
      ...
      e.target.closest(skipMouseDown)
    )
      return true
  ...
  _keyEvent: function(e) {
    ...
    if (e.key === "Escape") {
      ...
      grid
        .setAnimation(false) // immediate rotate so _getDragOffset() gets the right dom size below
        .rotate(n.el, {
  ...
  _createHelper: function() {
    ...
    this.dragElementOriginStyle = DDDraggable.originStyleProp.map(
  ...
  _removeHelperStyle: function() {
    ...
    if (!node?._isAboutToRemove && this.dragElementOriginStyle) {
      ...
      helper.style.transition = this.dragElementOriginStyle["transition"] =
        "none" // can't be NULL #1973
  ...
  _dragFollow: function(e) {
    ...
    style.left =
      (e.clientX + offset.offsetLeft - containmentRect.left) *
